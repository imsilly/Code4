...
package org.jivesoftware.xiff.events
{
	...
	public class RosterEvent extends Event
	{
		...
		{
			var rosterEvent:RosterEvent = new RosterEvent( type, bubbles, cancelable );
			rosterEvent.jid = jid;
			rosterEvent.data = data;
			return rosterEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "RosterEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}
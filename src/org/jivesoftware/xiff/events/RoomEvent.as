...
package org.jivesoftware.xiff.events
{
	...
	public class RoomEvent extends Event
	{
		...
		{
			var roomEvent:RoomEvent = new RoomEvent( type, bubbles, cancelable );
			roomEvent.subject = subject;
			roomEvent.message = message;
			roomEvent.data = data;
			roomEvent.errorCondition = errorCondition;
			roomEvent.errorMessage = errorMessage;
			roomEvent.errorType = errorType;
			roomEvent.errorCode = errorCode;
			roomEvent.nickname = nickname;
			roomEvent.from = from;
			roomEvent.reason = reason;
			return roomEvent;
		}

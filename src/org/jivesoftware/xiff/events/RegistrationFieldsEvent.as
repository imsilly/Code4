...
package org.jivesoftware.xiff.events
{
	...
	public class RegistrationFieldsEvent extends Event
	{
		...
		{
			var registrationFieldsEvent:RegistrationFieldsEvent = new RegistrationFieldsEvent();
			registrationFieldsEvent.fields = fields;
			registrationFieldsEvent.data = data;
			return registrationFieldsEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "RegistrationFieldsEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}
...
package org.jivesoftware.xiff.events
{
	...
	public class ModelChangedEvent extends Event
	{
		...
		{
			var modelChangedEvent:ModelChangedEvent = new ModelChangedEvent();
			modelChangedEvent.firstItem = firstItem;
			modelChangedEvent.lastItem = lastItem;
			modelChangedEvent.removedIDs = removedIDs;
			modelChangedEvent.fieldName = fieldName;
			return modelChangedEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "ModelChangedEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}

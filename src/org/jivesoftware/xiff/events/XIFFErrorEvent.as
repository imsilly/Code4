...
package org.jivesoftware.xiff.events
{
	...
	public class XIFFErrorEvent extends Event
	{
		...
		public override function clone():Event
		{
			...
			xiffErrorEvent.errorCondition = errorCondition;
			xiffErrorEvent.errorMessage = errorMessage;
			xiffErrorEvent.errorType = errorType;
			xiffErrorEvent.errorCode = errorCode;
			return xiffErrorEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "XIFFErrorEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}
...
{	 
	...
	public class ChangePasswordSuccessEvent extends Event
	{
		...
		{
			var changePasswordEvent:ChangePasswordSuccessEvent = new ChangePasswordSuccessEvent();
			return changePasswordEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "ChangePasswordSuccessEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}
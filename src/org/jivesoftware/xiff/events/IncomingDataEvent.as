...
package org.jivesoftware.xiff.events
{
	...
	public class IncomingDataEvent extends Event
	{
		...
		{
			var incomingDataEvent:IncomingDataEvent = new IncomingDataEvent();
			incomingDataEvent.data = data;
			return incomingDataEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "IncomingDataEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}
...
package org.jivesoftware.xiff.events
{
	...
	public class OutgoingDataEvent extends Event
	{
		...
		{
			var outgoingDataEvent:OutgoingDataEvent = new OutgoingDataEvent();
			outgoingDataEvent.data = data;
			return outgoingDataEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "OutgoingDataEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}
...
package org.jivesoftware.xiff.events
{
	...
	public class ConnectionSuccessEvent extends Event
	{
		...
		{
			var connectionSuccessEvent:ConnectionSuccessEvent = new ConnectionSuccessEvent();
			return connectionSuccessEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "ConnectionSuccessEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}
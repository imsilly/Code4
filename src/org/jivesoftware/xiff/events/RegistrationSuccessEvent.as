...
package org.jivesoftware.xiff.events
{
	...
	public class RegistrationSuccessEvent extends Event
	{
		...
		{
			var registrationSuccessEvent:RegistrationSuccessEvent = new RegistrationSuccessEvent();
			return registrationSuccessEvent;
		}
		
		public override function toString():String
		{
			return formatToString( "RegistrationSuccessEvent", "type", "bubbles", "cancelable", "eventPhase" ); 
		}
	}
}
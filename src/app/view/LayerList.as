package app.view
{
	...
	public class LayerList extends Sprite
	{
		...
		*   */
		public function LayerList (ease:Number = 1, direction:String = "vertical", setDraggerSize:Boolean = false, Width:Number = 530, Height:Number = 450, content:MovieClip = null)
		{
